...
par = coef(timeHOUSE.models$F3.C4$DEN.Child)
surf.DEN.Child =
...
par = coef(timeHOUSE.models$F3.C4$DEN.Homemaker)
surf.DEN.Homemaker =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$DEN.Other)
surf.DEN.Other =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$DEN.Student)
surf.DEN.Student =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$FEV.Child)
surf.FEV.Child =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$FEV.Homemaker)
surf.FEV.Homemaker =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$FEV.Other)
surf.FEV.Other =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$FEV.Student)
surf.FEV.Student =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$Healthy.Child)
surf.Healthy.Child =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$Healthy.Homemaker)
...
par = coef(timeHOUSE.models$F3.C4$Healthy.Other)
surf.Healthy.Other =
  matrix(dmvnorm(cbind(log(as.vector(f)), log(as.vector(d))),
                 c(par['freq.mean'], par['durn.mean']),
                 matrix(c(
...
par = coef(timeHOUSE.models$F3.C4$Healthy.Student)
...
tiff(filename = '../output/freqDurn_HOUSE.tiff', width = 960, height = 720)
