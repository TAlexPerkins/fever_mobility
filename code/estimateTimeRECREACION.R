...
partLoc = partLoc.all[
  which(
    partLoc.all$landuse_class == 'RECREACION' &
...
timeRECREACION.models = list()

# H:F3,C4
timeRECREACION.models$F3.C4 = list()
...
timeRECREACION.models$F3.C4$DEN.Child = mle2(
  minuslogl = likTime,
  start = list(
...
timeRECREACION.models$F3.C4$DEN.Homemaker = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$DEN.Other = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$DEN.Student = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$FEV.Child = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$FEV.Homemaker = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$FEV.Other = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$FEV.Student = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$Healthy.Child = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$Healthy.Homemaker = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$Healthy.Other = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$Healthy.Student = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C4$LL = sum(sapply(timeRECREACION.models$F3.C4, function(ll) logLik(ll)))

timeRECREACION.models$F3.C4$k = 5 * (length(timeRECREACION.models$F3.C4) - 1)



# H:F2,C4
timeRECREACION.models$F2.C4 = list()
...
timeRECREACION.models$F2.C4$DENFEV.Child = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F2.C4$DENFEV.Homemaker = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F2.C4$DENFEV.Other = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F2.C4$DENFEV.Student = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
durn = partLoc$absolute_duration[paste(partLoc$pathogen,partLoc$category) == 'NA Child']
freq = partLoc$absolute_frequency[paste(partLoc$pathogen,partLoc$category) == 'NA Child']
timeRECREACION.models$F2.C4$Healthy.Child = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
durn = partLoc$absolute_duration[paste(partLoc$pathogen,partLoc$category) == 'NA Homemaker']
freq = partLoc$absolute_frequency[paste(partLoc$pathogen,partLoc$category) == 'NA Homemaker']
timeRECREACION.models$F2.C4$Healthy.Homemaker = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
durn = partLoc$absolute_duration[paste(partLoc$pathogen,partLoc$category) == 'NA Other']
freq = partLoc$absolute_frequency[paste(partLoc$pathogen,partLoc$category) == 'NA Other']
timeRECREACION.models$F2.C4$Healthy.Other = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
durn = partLoc$absolute_duration[paste(partLoc$pathogen,partLoc$category) == 'NA Student']
freq = partLoc$absolute_frequency[paste(partLoc$pathogen,partLoc$category) == 'NA Student']
timeRECREACION.models$F2.C4$Healthy.Student = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F2.C4$LL = sum(sapply(timeRECREACION.models$F2.C4, function(ll) logLik(ll)))

timeRECREACION.models$F2.C4$k = 5 * (length(timeRECREACION.models$F2.C4) - 1)
...
timeRECREACION.models$F1.C4$Child = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F1.C4$Homemaker = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F1.C4$Other = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F1.C4$Student = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F1.C4$LL = sum(sapply(timeRECREACION.models$F1.C4, function(ll) logLik(ll)))

timeRECREACION.models$F1.C4$k = 5 * (length(timeRECREACION.models$F1.C4) - 1)
...
timeRECREACION.models$F3.C1$DEN = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C1$FEV = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C1$Healthy = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F3.C1$LL = sum(sapply(timeRECREACION.models$F3.C1, function(ll) logLik(ll)))

timeRECREACION.models$F3.C1$k = 5 * (length(timeRECREACION.models$F3.C1) - 1)
...
timeRECREACION.models$F2.C1$DENFEV = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
durn = partLoc$absolute_duration[partLoc$pathogen == 'NA']
freq = partLoc$absolute_frequency[partLoc$pathogen == 'NA']
timeRECREACION.models$F2.C1$Healthy = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F2.C1$LL = sum(sapply(timeRECREACION.models$F2.C1, function(ll) logLik(ll)))

timeRECREACION.models$F2.C1$k = 5 * (length(timeRECREACION.models$F2.C1) - 1)
...
timeRECREACION.models$F1.C1$ALL = mle2(
  minuslogl = likTime,
  start = list(
    freq.mean = mean(log(freq)),
    durn.mean = mean(log(durn)),
...
timeRECREACION.models$F1.C1$LL = sum(sapply(timeRECREACION.models$F1.C1, function(ll) logLik(ll)))

timeRECREACION.models$F1.C1$k = 5 * (length(timeRECREACION.models$F1.C1) - 1)
...
# test statistics
mat.teststat = matrix(NA,length(timeRECREACION.models),length(timeRECREACION.models))
row.names(mat.teststat) = names(timeRECREACION.models)
colnames(mat.teststat) = names(timeRECREACION.models)

mat.teststat['F3.C4','F2.C4'] =
  2 * (timeRECREACION.models$F3.C4$LL - timeRECREACION.models$F2.C4$LL)
mat.teststat['F3.C4','F1.C4'] =
  2 * (timeRECREACION.models$F3.C4$LL - timeRECREACION.models$F1.C4$LL)
mat.teststat['F3.C4','F3.C1'] =
  2 * (timeRECREACION.models$F3.C4$LL - timeRECREACION.models$F3.C1$LL)
mat.teststat['F3.C4','F2.C1'] =
  2 * (timeRECREACION.models$F3.C4$LL - timeRECREACION.models$F2.C1$LL)
mat.teststat['F3.C4','F1.C1'] =
  2 * (timeRECREACION.models$F3.C4$LL - timeRECREACION.models$F1.C1$LL)
mat.teststat['F2.C4','F1.C4'] =
  2 * (timeRECREACION.models$F2.C4$LL - timeRECREACION.models$F1.C4$LL)
mat.teststat['F2.C4','F2.C1'] =
  2 * (timeRECREACION.models$F2.C4$LL - timeRECREACION.models$F2.C1$LL)
mat.teststat['F2.C4','F1.C1'] =
  2 * (timeRECREACION.models$F2.C4$LL - timeRECREACION.models$F1.C1$LL)
mat.teststat['F1.C4','F1.C1'] =
  2 * (timeRECREACION.models$F1.C4$LL - timeRECREACION.models$F1.C1$LL)
mat.teststat['F3.C1','F2.C1'] =
  2 * (timeRECREACION.models$F3.C1$LL - timeRECREACION.models$F2.C1$LL)
mat.teststat['F3.C1','F1.C1'] =
  2 * (timeRECREACION.models$F3.C1$LL - timeRECREACION.models$F1.C1$LL)
mat.teststat['F2.C1','F1.C1'] =
  2 * (timeRECREACION.models$F2.C1$LL - timeRECREACION.models$F1.C1$LL)


# degrees of freedom
mat.df = matrix(NA,length(timeRECREACION.models),length(timeRECREACION.models))
row.names(mat.df) = names(timeRECREACION.models)
colnames(mat.df) = names(timeRECREACION.models)

mat.df['F3.C4','F2.C4'] =
  timeRECREACION.models$F3.C4$k - timeRECREACION.models$F2.C4$k
mat.df['F3.C4','F1.C4'] =
  timeRECREACION.models$F3.C4$k - timeRECREACION.models$F1.C4$k
mat.df['F3.C4','F3.C1'] =
  timeRECREACION.models$F3.C4$k - timeRECREACION.models$F3.C1$k
mat.df['F3.C4','F2.C1'] =
  timeRECREACION.models$F3.C4$k - timeRECREACION.models$F2.C1$k
mat.df['F3.C4','F1.C1'] =
  timeRECREACION.models$F3.C4$k - timeRECREACION.models$F1.C1$k
mat.df['F2.C4','F1.C4'] =
  timeRECREACION.models$F2.C4$k - timeRECREACION.models$F1.C4$k
mat.df['F2.C4','F2.C1'] =
  timeRECREACION.models$F2.C4$k - timeRECREACION.models$F2.C1$k
mat.df['F2.C4','F1.C1'] =
  timeRECREACION.models$F2.C4$k - timeRECREACION.models$F1.C1$k
mat.df['F1.C4','F1.C1'] =
  timeRECREACION.models$F1.C4$k - timeRECREACION.models$F1.C1$k
mat.df['F3.C1','F2.C1'] =
  timeRECREACION.models$F3.C1$k - timeRECREACION.models$F2.C1$k
mat.df['F3.C1','F1.C1'] =
  timeRECREACION.models$F3.C1$k - timeRECREACION.models$F1.C1$k
mat.df['F2.C1','F1.C1'] =
  timeRECREACION.models$F2.C1$k - timeRECREACION.models$F1.C1$k
